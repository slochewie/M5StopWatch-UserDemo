...
private:
    ...
    static esp_err_t handle_config_post(httpd_req_t* req)
    {
        ...
        httpd_resp_sendstr(req, "Saved. Reboot the StopWatch to use the new config.");
        return ESP_OK;
    }
